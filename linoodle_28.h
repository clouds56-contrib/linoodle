...
#define OODLE_API_VERSION 28
#define OODLE_DLL_NAME "oo2core_28_win64.dll"
...
#define __OODLE_API__TYPEDEF__ \
    ...
    typedef __attribute__((ms_abi)) void* (*tCompressOptions_GetDefault)(); \
    typedef __attribute__((ms_abi)) size_t (*tGetCompressedBufferSizeNeeded)(uint8_t unk, size_t src_len); \
    typedef __attribute__((ms_abi)) size_t (*tGetDecodeBufferSize)(uint8_t unk, size_t src_len, bool corruption_possible); \
...
#define __OODLE_API__MEMBER_METHODS__ \
    ...
    void* CompressOptions_GetDefault() { \
        WindowsLibrary::SetupCall(); \
        return m_CompressOptions_GetDefault(); \
    } \
    size_t GetCompressedBufferSizeNeeded(uint8_t unk, size_t src_len) { \
        WindowsLibrary::SetupCall(); \
        return m_GetCompressedBufferSizeNeeded(unk, src_len); \
    } \
    size_t GetDecodeBufferSize(uint8_t unk, size_t src_len, bool corruption_possible) { \
        WindowsLibrary::SetupCall(); \
        return m_GetDecodeBufferSize(unk, src_len, corruption_possible); \
    } \
// #end define __OODLE_API__MEMBER_METHODS__

#define __OODLE_API__MEMBER_DECLS__ \
    tDecompress m_Decompress; /* for OODLE_28::OodleLZ_Decompress */ \
    tCompress m_Compress; /* for OODLE_28::OodleLZ_Compress */ \
    tCompressOptions_GetDefault m_CompressOptions_GetDefault; /* for OODLE_28::OodleLZ_CompressOptions_GetDefault */ \
    tGetCompressedBufferSizeNeeded m_GetCompressedBufferSizeNeeded; /* for OODLE_28::OodleLZ_GetCompressedBufferSizeNeeded */ \
    tGetDecodeBufferSize m_GetDecodeBufferSize; /* for OODLE_28::OodleLZ_GetDecodeBufferSize */ \
...
#define __OODLE_API__EXTERN_FUNCS__ \
    ...
    extern "C" void* OodleLZ_CompressOptions_GetDefault() { \
        return g_oodleWrapper.CompressOptions_GetDefault(); \
    } \
    extern "C" size_t OodleLZ_GetCompressedBufferSizeNeeded(uint8_t unk, size_t src_len) { \
        return g_oodleWrapper.GetCompressedBufferSizeNeeded(unk, src_len); \
    } \
    extern "C" size_t OodleLZ_GetDecodeBufferSize(uint8_t unk, size_t src_len, bool corruption_possible) { \
        return g_oodleWrapper.GetDecodeBufferSize(unk, src_len, corruption_possible); \
    } \
